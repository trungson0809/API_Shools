...
namespace WebAPI_QuanLyHocSinh.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(db_schoolsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Classes != null ? 
                          ...
                          Problem("Entity set 'db_schoolsContext.Classes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'db_schoolsContext.Classes'  is null.");
            }
            var @class = await _context.Classes.FindAsync(id);
            if (@class != null)
            {
